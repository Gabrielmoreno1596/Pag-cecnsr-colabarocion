<footer id="contacto" class="site-footer" role="contentinfo">
    <div class="site-footer__top container">
        <!-- Enlaces -->
        <nav class="footer-block" aria-label="Enlaces rapidos">
            ...
            <ul class="footer-links">
                ...
                <li><a href="<?= BASE_URL ?>escolar.php">Útiles Escolares 2026</a></li>
                <li><a href="<?= BASE_URL ?>proceso-admision.php">Contactanos</a></li>
            </ul>
        </nav>
        ...
        <section class="footer-block">
            ...
            <ul class="contact-list" itemscope itemtype="https://schema.org/Organization">
                <li class="contact-list__item">
                    ...
                    <span itemprop="address">Calle 15 de Septiembre Av. San Jose No. 286, San Marcos, San Salvador</span>
                </li>
                <li class="contact-list__item">
                    <i class="fas fa-phone" aria-hidden="true"></i>
                    <a href="tel:+50325031970" class="contact-link">2503 - 1970 / 2220 - 6927</a>
                    <!-- <span class="sep"> / </span> -->
        ...
        <!-- Horario -->
        <section class="footer-block">
            <h4 class="footer-block__title">Horario de atencion</h4>
            <p class="footer-text">
                Lunes a Viernes:<br>
...
<!-- Ideal: carga el CSS del footer en el <head> via $PAGE_HEAD. Si prefieres aqui, tambien funciona: -->
