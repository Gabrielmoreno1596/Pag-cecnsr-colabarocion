...
function normalize_level(string $level): string
{
    ...
    if (str_contains($lower, 'parvularia') || str_contains($lower, 'educación inicial') || str_contains($lower, 'educacion inicial')) {
        return 'Educación Inicial y Parvularia';
    }
...
// Orden deseado
$levelOrder = ["Educación Inicial y Parvularia", "I Ciclo", "II Ciclo", "III Ciclo", "Bachillerato", "Otros"];
