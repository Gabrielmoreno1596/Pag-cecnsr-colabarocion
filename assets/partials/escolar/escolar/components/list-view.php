                ...
                <div class="school-tools__grid">
                    ...
                    <article class="school-tools-note">
                        ...
                        <?php if (!empty($data["notes"])): ?>
                            <?php foreach ($data["notes"] as $line): ?>
                                <p class="school-print-note-line"><?= htmlspecialchars($line) ?></p>
                            <?php endforeach; ?>
                        <?php elseif (!empty($data["note"])): ?>
                            <?php foreach ($data["note"] as $line): ?>
                                <p class="school-print-note-line"><?= htmlspecialchars($line) ?></p>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="school-print-note-line">Pr&oacute;ximamente.</p>
                        <?php endif; ?>
                    </article>
