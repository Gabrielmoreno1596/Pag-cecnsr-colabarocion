  ...
  'quicklinks' => [
    ...
    'items' => [
      [
        ...
        'image' => asset('assets/img/inicio/home-structure/logistica-global.jpg'),
      ],
      [
        ...
        'image' => asset('assets/img/inicio/home-structure/cancha-1nivel2.jpeg'), /* Imagen accesos rápido, oferta académica */
      ],
      [
        ...
        'image' => asset('assets/img/inicio/home-structure/i2.jpg'), /* imagen accesos rápido, infraestructura */
      ],
      [
        'title' => 'Convenios',
        ...
        'icon'  => 'fa-handshake',
        'image' => asset('assets/img/inicio/home-structure/pasch-img3.jpeg'), /* imagen de accesos rápido, convenios */
      ],
      [
        ...
        'icon'  => 'fa-cross',
        'image' => asset('assets/img/inicio/home-structure/cancha-desde-gradas-derecha.jpeg'),
      ],
      [
        'title' => '¿Quiénes somos?',
        ...
        'icon'  => 'fa-circle-info',
        'image' => asset('assets/img/inicio/historia/h1.jpeg'),
      ],
    ],
  ],
  ...
  'oferta' => [
    ...
    'items' => [
      [
        ...
        'href'  => asset('oferta-inicial.php'),
        'icon'  => 'fa-seedling',
        'image' => asset('assets/img/inicio/infraestructura/i5.jpeg'),
      ],
      [
        'title' => 'I Ciclo',
        ...
        'icon'  => 'fa-book-open',
        'image' => asset('assets/img/inicio/infraestructura/i1.jpg'),
      ],
      [
        'title' => 'II Ciclo',
        ...
        'icon'  => 'fa-compass',
        'image' => asset('assets/img/inicio/infraestructura/i6.jpeg'),
      ],
      [
        'title' => 'III Ciclo',
        ...
        'icon'  => 'fa-lightbulb',
        'image' => asset('assets/img/inicio/infraestructura/i2.jpg'),
      ],
      [
        'title' => 'Bachillerato',
        ...
        'icon'  => 'fa-user-tie',
        'image' => asset('assets/img/inicio/infraestructura/i7.jpeg'),
      ],
    ],
  ],
  ...
  'convenios' => [
    ...
    'items' => [
      [
        ...
        'href'  => asset('convenios-pasch.php'),
        'icon'  => 'fa-globe',
        'image' => asset('assets/partials/inicio/image/hero/10.jpg'),
      ],
      [
        'title' => 'Proyecto Dual',
        ...
        'icon'  => 'fa-industry',
        'image' => asset('assets/img/inicio/hero/9.jpg'),
      ],
      [
        'title' => 'Programa Dual',
        ...
        'icon'  => 'fa-brain',
        'image' => asset('assets/img/inicio/historia/h2.jpeg'),
      ],
      [
        'title' => 'Integración',
        ...
        'image' => asset('assets/img/inicio/hero/6.jpeg'),
      ],
    ],
  ],
  ...
  'pastoral' => [
    ...
    'items' => [
      [
        ...
        'href'  => asset('pastoral-educativa.php'),
        'icon'  => 'fa-church',
        'image' => asset('assets/img/inicio/historia/h4.jpeg'),
      ],
      [
        ...
        'icon'  => 'fa-star',
        'image' => asset('assets/img/inicio/hero/2.jpeg'),
      ],
      [
        'title' => 'Galería',
        ...
        'icon'  => 'fa-images',
        'image' => asset('assets/img/inicio/hero/7.jpeg'),
      ],
    ],
  ],
];
