// Reveal on scroll (Oferta II Ciclo) - sin tocar el contenido (solo auto-tag por selectores)
(() => {
...
const tag = () => {
  ...
  // VALORES
  set(document.querySelector('.bg-blue-accent .content-wrapper > p.text-white'), { variant: 'up', delay: 120 });
  setMany(document.querySelectorAll('.service-circles-grid .service-circle-item'), { variant: 'scale', start: 140, step: 90 });

  // ADMISION (acordeón) - detecta el section id real si cambia en data
