<?php
return [
    'eyebrow' => 'Convenios · Formación Técnico-Laboral',
    'title'   => 'Proyecto DUAL — estudiar y trabajar en Alemania',
    'lead_html' => 'Acompañamos a nuestros egresados para que continúen su formación técnica y laboral en Alemania a través de un modelo dual: <strong>estudio + trabajo</strong>, con preparación académica y cultural en el CECNSR.',
    'points'  => [
        'Clases de alemán y orientación intercultural en el colegio.',
        'Acompañamiento para postulación, entrevistas y documentos.',
