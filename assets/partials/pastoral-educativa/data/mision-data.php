...
return [
    ...
    'tabs' => [
        [
            ...
            'img'   => asset('assets/pastoralEducativa/primer-ciclo.jpeg'),
        ],
        [
            'key'   => 'Juzgar',
            ...
            'img'   => asset('assets/pastoralEducativa/celebraciones/cancha-desde-escenario2.jpeg'),
        ],
        [
            'key'   => 'Actuar',
            ...
            'img'   => asset('assets/pastoralEducativa/celebraciones/san-francisco-tercer-ciclo.jpeg'),
        ],
        [
            'key'   => 'Celebrar',
            ...
            'img'   => asset('assets/pastoralEducativa/celebraciones/cancha-desde-gradas-derecha.jpeg'),
        ],
    ],
    // Texto "leer más"
    'more' => [
