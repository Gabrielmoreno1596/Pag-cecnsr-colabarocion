...
<body>
    ...
    <div class="page-header">
        ...
        <p>Aquí puedes colocar una frase que resuma el objetivo de este nivel o convenio.</p>
    </div>
    ...
    <section class="main-content">
        ...
        <div class="content-section">
            <h2 class="sub-title">Beneficios y Enfoque</h2>
            <p>Detalle los puntos fuertes de este programa en específico:</p>
            <ul>
                <li><i class="fas fa-check-circle" style="color: var(--cecns-gold);"></i> **Pilar 1:** Descripción detallada del primer punto fuerte.</li>
                <li><i class="fas fa-check-circle" style="color: var(--cecns-gold);"></i> **Pilar 2:** Descripción detallada del segundo punto fuerte.</li>
    ...
    <footer id="contacto" class="main-footer">
        <div class="footer-grid">
            <div class="footer-info">
                <h4>Contacto</h4>
                <p><i class="fas fa-map-marker-alt"></i> Calle 15 de Septiembre Av. San José No. 286, San Marcos, San Salvador</p>
        ...
        <div class="copyright">
            <p>&copy; 2025 CECNSR. Todos los derechos reservados. Desarrollado con 💙 en El Salvador.</p>
        </div>
    </footer>
