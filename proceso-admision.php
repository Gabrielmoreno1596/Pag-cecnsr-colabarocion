        ...
        >
          <div class="form-group">
            <label for="nombre_padre"
              >Nombre completo del Padre/Madre/Encargado:</label
            >
            <input
              type="text"
              id="nombre_padre"
          ...
          <div class="form-group">
            <label for="telefono"
              >Teléfono de Contacto (WhatsApp preferible):</label
            >
          ...
          <div class="form-group">
            <label for="correo"
              >Correo Electrónico (Para recibir la información):</label
            >
            <input
              type="email"
              id="correo"
          ...
          <div class="form-group">
            <label for="estudiante_grado"
              >Grado de Interés para el Estudiante:</label
            >
          ...
          <div class="form-group">
            <label for="consulta"
              >Consulta Específica o Comentarios Adicionales:</label
            >
